 ...
 * @param simbolo El símbolo que se va a insertar en el alfabeto.
 * @return Un objeto de la clase Alfabeto con el símbolo insertado.
 */
Alfabeto Alfabeto::InsertarSimbolo(Simbolo simbolo) {
 ...
 * @param simbolo El símbolo que se va a verificar si pertenece al alfabeto.
 * @return true si el símbolo pertenece al alfabeto, false en caso contrario.
 */
bool Alfabeto::PerteneceAlfabeto(Simbolo simbolo) const {
